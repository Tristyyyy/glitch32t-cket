            ...
            selectMenu.addOptions([
                {
                    emoji: '🎟️',
                    label: 'Genel',
                    description: 'Genel Bir Sorun Varsa Buna Tıkla',
                    value: 'ticket31'
                },
                {
                    emoji: '🎟️',
                    label: 'Market',
                    description: 'Marketten Birşey Alacaksan Buna Tıkla',
                    value: 'ticket31_şikayet'
                },
                {
                    emoji: '🎟️',
                    label: 'Çekiliş',
                    description: 'Çekiliş Kazandıysan Ödülünü Almak İçin Buna Tıkla',
